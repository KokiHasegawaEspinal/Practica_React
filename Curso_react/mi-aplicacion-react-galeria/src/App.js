...
function GaleriaDeImagenes() {
  const [imagenes, setImagenes] = useState([
    { src: 'imgs/a.jpg', alt: 'Imagen 1', caption: 'Pie de foto Imagen 1' },
    { src: 'imgs/b.png', alt: 'Imagen 2', caption: 'Pie de foto Imagen 2' },
    { src: 'imgs/c.bmp', alt: 'Imagen 3', caption: 'Pie de foto Imagen 3' },
    { src: 'imgs/d.jpeg', alt: 'Imagen 4', caption: 'Pie de foto Imagen 4' }
  ]);
